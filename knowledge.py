...
class Knowledge(object):
    ...
    def find_weather(self):
        ...
        weather_req_url = "https://api.darksky.net/forecast/%s/%s,%s?lang=%s&units=%s" % (self.weather_api_token, lat, lon,lang,units)
    ...
    def get_location(self):
        # get location
        location_req_url = "http://freegeoip.net/json/157.49.140.90" #% self.get_ip()
...
#https://holidayapi.com/v1/holidays?key=8a6963b4-51ba-4312-80af-09ef50fe6502&country=IN&year=2016
        return holidays
